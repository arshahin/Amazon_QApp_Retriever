...
python src\get_qapps_info.py --config input/custom_config.yml

# Specify both config and credentials
python src\get_qapps_info.py --config input/config.yml --env config/.env
```
